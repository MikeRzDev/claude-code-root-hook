...
echo
echo "Default backend: Keychain (set CLAUDE_SUDO_BACKEND=file to use a plaintext"
echo "file cache instead). Restart Claude Code so it reloads settings.json, then"
echo "run a 'sudo' command — you should get one native macOS password prompt."
